...
layout: archive-post
title: Simplex
excerpt: "Linear Programming and Introduction to Optimization Assignment: An implementation of simplex and two-phase simplex algorithms."
categories: archive
tags: [linear-programming, simplex, python]
comments: true
share: true
modified: 2017-09-01
---
...
<div markdown="0" style="text-align: center"><a href="https://github.com/viniciusarruda/simplex" target="_blank" class="btn">CHECKOUT THE CODE ON GITHUB</a></div>
